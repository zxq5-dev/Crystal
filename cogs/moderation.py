...
class Moderation(commands.Cog):
    ...
    async def kick(self, message, member : discord.Member, *, reason = None):
        if member == client.user:
            ...
            await member.send(embed = discord.Embed(title = f"you have been kicked from server: {ctx.guild.name}", color = discord.Colour.red()))
    ...
    async def ban(self, message, member : discord.Member, *, reason = None):
        if member == client.user:
            ...
            await member.send(embed = discord.Embed(title = f"you have been banned from server: {ctx.guild.name}", color = discord.Colour.red()))
    ...
    async def rules(self, message):
        embed = discord.Embed(title="rules:", description = "the rules of the server:", color = discord.Colour.blue())
